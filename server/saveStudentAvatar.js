...
const saveStudentImageToFilesystem = (imageData, filename, callback) => { 
    const imagePath = path.join(studentAvatarFolderPath, filename); 
...
const generateRandomFilename = () => {
  ...
  export  {saveStudentImageToFilesystem, generateRandomFilename}